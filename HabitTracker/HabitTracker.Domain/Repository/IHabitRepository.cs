...
namespace HabitTracker.Domain.Repository
{
    public interface IHabitRepository
    {
        ...
        Task<Habit> GetHabitByIdAsync(int habitId, CancellationToken cancellationToken = default);
        Task<Habit> CreateHabitAsync(Habit habit, CancellationToken cancellationToken = default);
